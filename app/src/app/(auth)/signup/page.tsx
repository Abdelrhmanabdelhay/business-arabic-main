...
export default function SignUpPage() {
  ...
  const { signUp, isPending } = SignUpMutation();
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="p-6 space-y-6">
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    <Input
                      ...
                      startContent={<FiUser className="text-2xl text-default-400 pointer-events-none flex-shrink-0" />}
              ...
              <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.4 }}>
                <Button
                  ...
                  size="lg"
                  isLoading={isPending}>
                  {isPending ? "جارِ إنشاء الحساب..." : "إنشاء حساب"}
                </Button>
              </motion.div>
